...
export const ProductSchema = z.object({
  ...
  barcode: z.number({ error: "Por favor, ingrese un código de barras válido" }).nonnegative(),
  stock: z
    .number({
  ...
  supplier_id: z.coerce.number({ error: "Por favor, seleccione un proveedor" }).nonnegative(),
  category_id: z.coerce.number({ error: "Por favor, seleccione una categoría" }).nonnegative(),
